  ...
  return (
    <div className="targetSlides"> 
        ...
        <div className="grid_container">
            ...
            <a href="https://www.linkedin.com/in/audrenavacirca" target="blank"><img alt="" className="avatar audrena" src="./assets/audrena.png"></img></a>
                <img alt="" className="qr" src="./assets/audrenaQR.png"></img>
                <p className="title">Audrena Vacirca</p>
            </section>
            <section className="grid__child-two">
                <a href="https://www.linkedin.com/in/graciechoi" target="blank"><img alt="" className="avatar grace" src="./assets/grace.png"></img></a>
                <img alt="" className="qr" src="./assets/graceQR.png"></img>
                <p className="title">Grace Choi</p>
            </section>
            <section className="grid__child-three">
                <a href="https://www.linkedin.com/in/nebiyu-kifle" target="blank"><img alt="" className="avatar nebiyu" src="./assets/nebiyu.png"></img></a>
                <img alt="" className="qr" src="./assets/nebiyuQR.png"></img>
                <p className="title">Nebiyu Kifel</p>
            </section>
            <section className="grid__child-four">
            <a href="https://www.linkedin.com/in/sianculligan" target="blank"><img alt="" className="avatar sian" src="./assets/sian.png"></img></a>
